...
int main(){
  ...
  list1.insert(x, list1.begin());
	...
	list1.clear();
	cout << "Dopo clear list1=" ; cout << list1;
	
	iter = list2.begin();
	while (!list2.end(list2.next(iter)))
		iter = list2.next(iter);
	cout << "num_elements : " << list2.num_elements(list2.begin(), iter) << endl;

	list2.move_min_max();
	cout << "Dopo min_max list2=" ; cout << list2;

	list2.exchange(list2.begin(), iter);
	cout << "Dopo exchange list2=" ; cout << list2;
